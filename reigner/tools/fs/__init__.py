...
Raw FS tools are riskier than the artifact tools: they are bounded by
configurable caps but they are not self-describing in the same way artifact
tools are — there is no schema behind the paths, only the project's repo on
disk.
"""
